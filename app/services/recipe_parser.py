...
class RecipeParserService:
    ...
    def extract_recipe_from_structured_data(structured_recipe: dict):
        ...
        nutrition_entity = NutritionEntity(
            energy_kcal=RecipeParserService._parse_int(nutrition.get("calories", 0)),
            carbohydrates=RecipeParserService._parse_float(nutrition.get("carbohydrateContent", 0)),
            sugars=RecipeParserService._parse_float(nutrition.get("sugarContent", 0)),
            proteins=RecipeParserService._parse_float(nutrition.get("proteinContent", 0)),
